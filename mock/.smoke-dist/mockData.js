import { computeCompositeScore, computeDeterministicScore } from "@fastloop/shared";
function buildBreakdown(seed, durationTargetSeconds) {
...
export function createMockCandidates(trackId, durationTargetSeconds = 8, scoringMode = "smart") {
    const windows = [
...
export function createMockAnalysis(trackId, durationTargetSeconds = 8, scoringMode = "smart") {
    return {
        trackId,
        bpm: 124,
        bars: 48,
