...
export async function mountApp(root, options) {
    ...
    function updateExportDirectory(nextPath) {
    ...
    async function chooseTrackSource() {
        try {
    ...
    function bindEvents() {
        ...
        root.querySelector("#export-directory-input")?.addEventListener("input", (event) => {
            updateExportDirectory(event.currentTarget.value);
        });
